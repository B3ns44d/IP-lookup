...
#
#
#Coded by Abdessamad Bensaad and Black-B (Black-B It's a pseudonym for Abdessamad Bensaad)
import os
import sys
...
|__/|__/_/ /_/\____/___//____/
	  ...
	  os.system("git clone https://github.com/bensaad2/Black-B.git")
	  os.system("cd Black-B && sudo bash ./update.sh")
	  os.system("Black-B")
    elif choice == 2:
      d3 = raw_input('Enter IP Or Domain : ')
      os.system("clear")
